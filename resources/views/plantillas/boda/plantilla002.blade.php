...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Great+Vibes&display=swap"
    ...
    <!-- Estilos -->
    <link rel="stylesheet" href="{{ asset('css/plantillas/boda/plantilla002.css') }}">
...
<div id="book">
    <!-- Página 1: Portada -->
      ...
      <!-- Página 2: Doble página (foto + recuerdo) -->
      <div class="page" id="page-2">
        <div class="spread d-flex">

          <!-- Lado izquierdo: foto de los novios -->
          <div class="page-half left-page">
            <section class="hero h-100">
              <img src="{{ asset('images/plantillas/boda/plantilla001/hero.jpg') }}"
                   alt="Foto de los novios">
            </section>
          </div>

          <!-- Lado derecho: “Un Recuerdo Especial” -->
          <div class="page-half right-page">
            <section class="memory h-100 d-flex flex-column justify-content-center animate__animated animate__fadeInUp">
      ...
      <!-- Página 3: Doble página (Tarjeta con info + fecha) -->
      <div class="page" id="page-3">
        <div class="spread d-flex">

          <!-- Lado izquierdo: Tarjetea Blanca cin info y padrinos -->
          <div class="page-half left-page">
      ...
      <!-- Página 3: Doble página (Lugar + Itinerario) -->
      ...
      <!-- Página 4: Doble página (Vestimenta + Mesa de regalos) -->
      <div class="page" id="page-4">
        <div class="spread d-flex">
      ...
      <!-- Página 5: Doble página (Fotos + Invitacion) -->
            ...
            <section class="invitation-section py-5 animate__animated animate__fadeInUp">
              <div class="container text-center">
                ...
                <div class="mt-3">
                  ...
                  <p class="mt-3" style="max-width: 600px; margin: auto; font-size: 1rem;">
      ...
      <!-- Página 6: Doble página (Confirmación + Whatsapp) -->
  ...
  <div class="nav right" onclick="nextPage()">❯</div>
    ...
    <script>
      ...
      function showPage(n) {
        pages.forEach((p, i) => {
          p.classList.toggle('current', i === n-1);
        });
      }
