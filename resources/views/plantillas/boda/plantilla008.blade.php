...
<head>
  ...
  <meta charset="UTF-8">
  <title>Invitación de Boda • Plantilla 007</title>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Dancing+Script&family=Playfair+Display&display=swap" rel="stylesheet">
    ...
    <!-- Estilos -->
    <link rel="stylesheet" href="{{ asset('css/plantillas/boda/plantilla008.css') }}?v={{ time() }}">
...
<body>
    ...
    <!-- 1) HERO DE LA BODA -->
    <section class="hero">
        <img src="{{ asset('images/plantillas/boda/plantilla008/fondokoi.png') }}" alt="Fondo decorativo">

        <div class="frase-boda">
            <div class="titulo">¡NOS CASAMOS!</div>

            <div class="nombres-vertical">
                <div class="nombre">Kido</div>
                <div class="simbolo" style="color: #1B3C53;">&</div>
                <div class="nombre">Kenia</div>
            </div>
        </div>
    </section>
    ...
    <section class="historia-section fondo-fijo" style="background-image: url('{{ asset('images/plantillas/boda/plantilla001/hero.jpg') }}')">
      ...
      @php
        $bloques = [
          [
            ...
            'posicion' => 'izquierda',
            'imagen'   => 'images/plantillas/boda/plantilla008/koi2.gif',
          ],
          [
            'titulo'   => 'No es el fin...',
          ...
          [
            'titulo'   => 'Yo soy para ti y tú eres para mí.',
            'texto'    => '7 años de noviazgo han pasado y sabemos que siempre fuimos lo que buscábamos para toda nuestra vida. Por lo que hoy, estamos a punto de dar el SÍ en el altar que unirá nuestro futuro.',
            'posicion' => 'izquierda',
            'imagen'   => 'images/plantillas/boda/plantilla008/koi2.gif',
          ],
        ];
      ...
      @foreach($bloques as $bloque)
        <div
          class="texto-historia {{ $bloque['posicion'] }}"
          style="
            background-image: url('{{ asset($bloque['imagen']) }}');
    ...
    <!-- 3) RECUERDO -->
    <section class="info-card animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/koi.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
    <div class="container">
    ...
    <section class="info-card" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/iok.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">

        <div style="text-align:center; margin: 2rem 0;">
          <img src="{{ asset('images/plantillas/boda/plantilla008/ornamental2.png') }}" alt="Divisor decorativo" style="width: 150px;">
        </div>
        ...
        <div style="text-align:center; margin: 2rem 0;">
          <img src="{{ asset('images/plantillas/boda/plantilla008/fish.png') }}" alt="Divisor decorativo" style="width: 150px;">
        </div>
    ...
    <!-- 4) FECHA -->
    <section class="wedding-date text-center py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/koi.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
        <div style="text-align:center; margin: 2rem 0;">
    ...
    <!-- 5) LUGAR -->
    <section class="location-section text-center py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/iok.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
        <div class="container">
            <!-- Ícono de anillos -->
            <div style="text-align:center; margin: 2rem 0;">
            ...
            <!-- Ícono de anillos -->
            <div style="text-align:center; margin: 2rem 0;">
              <img src="{{ asset('images/plantillas/boda/plantilla006/hindu.png') }}" alt="Divisor decorativo" style="width: 150px;">
            </div>
    ...
    <!-- 5) ITINERARIO -->
    <section class="itinerary-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/koi.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
    ...
    <!-- 6) VESTIMENTA -->
    <section class="dresscode-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/iok.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
    ...
    <!-- 7) MESA DE REGALOS -->
    <section class="gift-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/koi.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
    ...
    <!-- 8) FOTOS -->
    <section class="gallery-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/iok.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
        <div class="container text-center">
            <h2 class="mb-4" style="font-family: 'Playfair Display', serif; letter-spacing: 2px;">
                NUESTROS MOMENTOS
            </h2>
    ...
    <section class="photo-upload-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/koi.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
        <div class="container text-center">
            <div style="text-align:center; margin: 2rem 0;">
            ...
            <a href="{{ route('camila.galeria') }}" class="btn btn-outline-warning px-5 py-2" style="color: white;">
                📸 Ver y subir fotos
            </a>
        </div>
    </section>
    ...
    <section class="confirm-section py-5 animate__animated animate__fadeInUp" style="background-image: url('{{ asset('images/plantillas/boda/plantilla008/iok.gif') }}'); background-size: 600px 600px; background-repeat: repeat; background-color: transparent;">
      <div class="container text-center">
